  ...
  return (
    <section className="relative overflow-hidden h-160 sm:h-screen w-full">
      ...
      <div className="h-full md:h-screen w-full px-4 sm:px-15 md:px-30 lg:px-70 pt-20 flex items-center justify-center flex-col bg-linear-to-br from-sky-100 via-white to-purple-100 dark:from-zinc-950 dark:via-zinc-900 dark:to-indigo-950">
        {/* BLUBS */}
        <motion.div
          animate={{ x: [0, 80, -40, 0], y: [0, -50, 60, 0] }}
          transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
          className="w-[350px] h-[350px] rounded-full bg-purple-400/30 absolute left-20 top-20 blur-[120px] dark:bg-purple-600/20"
        ></motion.div>
        <motion.div
          animate={{ x: [0, -80, 50, 0], y: [0, 70, -40, 0] }}
          transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
          className="w-[400px] h-[400px] rounded-full bg-sky-400/30 absolute right-20 bottom-20 blur-[120px] dark:bg-blue-600/20"
        ></motion.div>
        ...
        <div className="flex items-center justify-center flex-1 md:flex-2 w-full flex-col">
          <div className="w-auto flex items-center justify-center flex-1 gap-2 mt-5 md:mt-15 lg:mt-20 z-200 ">
            <motion.div
              ...
              className="bg-white dark:bg-zinc-600 rounded-full px-3 py-2 md:px-4 md:py-2 gap-2 flex items-center justify-center mb-5"
            >
              <div className="w-2 h-2 bg-green-500 dark:bg-green-300 rounded-full relative"></div>
          ...
          <div className="flex items-center justify-center flex-7 w-full flex-col gap-6 md:text-2xl z-200">
            <motion.h1
              ...
              className="font-bold text-4xl sm:text-5xl lg:text-6xl text-center leading-13"
            >
              Hi, I'm{" "}
              <span className="text-purple-500">
                Afshin <br className="block md:hidden sm:hidden" /> Sohrabi
              </span>
            </motion.h1>
        ...
        <div className="flex items-center justify-between md:justify-between md:gap-8 flex-1 w-full flex-col pb-5 lg:px-20 z-200">
          <div className="text-center  text-muted-foreground text-base dark:text-zinc-400 flex items-center justify-center flex-1">
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.8 }}
              className="text-center  text-muted-foreground text-base dark:text-zinc-400"
            >
              I create modern, responsive, and user-friendly web experiences.
              I work with{" "}
              <b className="text-zinc-700  dark:text-zinc-300">JavaScript</b> ,{" "}
              <b className="text-zinc-700  dark:text-zinc-300">React</b> ,
              <b className="text-zinc-700 dark:text-zinc-300">Tailwind Css</b> ,{" "}
              <b className="text-zinc-700  dark:text-zinc-300">Next Js</b> and
              modern UI tools to build clean interfaces.
            </motion.p>
          </div>
